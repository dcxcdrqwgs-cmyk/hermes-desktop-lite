  ...
  return (
    <div
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transform-gpu transition-[left,right,width,opacity] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] md:flex",
          side === "left"
